...
if Notsquare == 0
    ...
    %1
    % Del aclamado autor del 2 de la función paint llega el 1 de la función
    % HyperuniformityReal. Que querria decir el autor de estos
    % pictogramas?? Quizas nunca lo sepamos
    Xsize = XLim(2) - XLim(1);
    Ysize = YLim(2) - YLim(1);
...
for repeticiones = 1:100
    ...
    %Por tu salud mental deja esto sin punto y coma lo echaras de menos
    %creeme
    repeticiones
